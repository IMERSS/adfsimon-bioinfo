...
st_write(grid.1890.1910, "outputs/gridded_history_1897-1910.shp")

st_write(grid.1890.1920, "outputs/gridded_history_1897-1920.shp")

st_write(grid.1890.1930, "outputs/gridded_history_1897-1930.shp")

st_write(grid.1890.1940, "outputs/gridded_history_1897-1940.shp")

st_write(grid.1890.1950, "outputs/gridded_history_1897-1950.shp")

st_write(grid.1890.1960, "outputs/gridded_history_1897-1960.shp")

st_write(grid.1890.1970, "outputs/gridded_history_1897-1970.shp")

st_write(grid.1890.1980, "outputs/gridded_history_1897-1980.shp")

st_write(grid.1890.1990, "outputs/gridded_history_1897-1990.shp")

st_write(grid.1890.2000, "outputs/gridded_history_1897-2000.shp")

st_write(grid.1890.2010, "outputs/gridded_history_1897-2010.shp")
