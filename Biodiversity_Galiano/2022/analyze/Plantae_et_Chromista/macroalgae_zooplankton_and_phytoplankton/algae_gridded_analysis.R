...
algae <- read.csv("../../../consolidate_records/Plantae_et_Chromista/macroalgae_zooplankton_and_phytoplankton/synthesized/Galiano_marine_algae_records_consolidated_2023-04-18.csv")
animals <- read.csv("../../../consolidate_records/Animalia/marine_animals/synthesized/Galiano_marine_animal_records_consolidated_2023-04-19.csv")
...
algae.grid.map = tm_shape(red.algae.grid.count) +
  tm_fill(
    col = "richness",
    palette = "viridis",
    style = "cont",
...
st_write(algae.grid, "outputs/algae_grid.shp")
st_write(algae.records.gridded, "outputs/algae_records_gridded.shp")

st_write(green.algae.grid, "outputs/green_algae_grid.shp")
st_write(green.algae.records.gridded, "outputs/green_algae_records_gridded.shp")

st_write(red.algae.grid, "outputs/red_algae_grid.shp")
st_write(red.algae.records.gridded, "outputs/red_algae_records_gridded.shp")

st_write(brown.algae.grid, "outputs/brown_algae_grid.shp")
st_write(brown.algae.records.gridded, "outputs/brown_algae_records_gridded.shp")
