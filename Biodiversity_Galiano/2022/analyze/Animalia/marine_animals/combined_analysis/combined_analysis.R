...
setwd(str_glue("{projroot}/Biodiversity_Galiano/2022"))
...
dir.exists("consolidate_records/Plantae_et_Chromista/macroalgae_zooplankton_and_phytoplankton/synthesized/")
