#### Animate / time-slice terrestrial arthropod reporting network
#### Uses exported network objects from the terrestrial arthropod reporting script
...
INPUT_DIR <- "outputs/terrestrial_arthropods/network_animation"
FRAME_DIR <- file.path(INPUT_DIR, "frames")

EDGE_FILE <- file.path(INPUT_DIR, "terrestrial_arthropods_network_edges.csv")
NODE_FILE <- file.path(INPUT_DIR, "terrestrial_arthropods_network_nodes.csv")
LAYOUT_FILE <- file.path(INPUT_DIR, "terrestrial_arthropods_network_layout.csv")
WINDOW_FILE <- file.path(INPUT_DIR, "terrestrial_arthropods_network_plot_window.csv")
FRAME_LOG_FILE <- file.path(INPUT_DIR, "terrestrial_arthropods_network_frame_log.csv")

FRAME_PREFIX <- "terrestrial_arthropods_network"
GIF_FILE <- file.path(INPUT_DIR, "terrestrial_arthropods_network_growth.gif")
