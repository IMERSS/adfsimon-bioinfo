...
write_csv(dat, file.path(OUTPUT_DIR, "birds_central_accounting_table.csv"))
cat("
Saved file: ", file.path(OUTPUT_DIR, "birds_central_accounting_table.csv"), "
", sep = "")
...
write_csv(edges_export, file.path(NETWORK_OUTPUT_DIR, "birds_network_edges.csv"))
write_csv(nodes_export, file.path(NETWORK_OUTPUT_DIR, "birds_network_nodes.csv"))
write_csv(layout_export, file.path(NETWORK_OUTPUT_DIR, "birds_network_layout.csv"))
write_csv(plot_window_export, file.path(NETWORK_OUTPUT_DIR, "birds_network_plot_window.csv"))

cat("\nSaved network animation files:\n")
cat("  ", file.path(NETWORK_OUTPUT_DIR, "birds_network_edges.csv"), "\n", sep = "")
cat("  ", file.path(NETWORK_OUTPUT_DIR, "birds_network_nodes.csv"), "\n", sep = "")
cat("  ", file.path(NETWORK_OUTPUT_DIR, "birds_network_layout.csv"), "\n", sep = "")
cat("  ", file.path(NETWORK_OUTPUT_DIR, "birds_network_plot_window.csv"), "\n", sep = "")
