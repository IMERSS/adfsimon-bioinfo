#### Animate / time-slice marine animal reporting network
#### Uses exported network objects from the marine animal reporting script
...
INPUT_DIR <- "outputs/marine_animals/network_animation"
FRAME_DIR <- file.path(INPUT_DIR, "frames")

EDGE_FILE <- file.path(INPUT_DIR, "marine_animals_network_edges.csv")
NODE_FILE <- file.path(INPUT_DIR, "marine_animals_network_nodes.csv")
LAYOUT_FILE <- file.path(INPUT_DIR, "marine_animals_network_layout.csv")
WINDOW_FILE <- file.path(INPUT_DIR, "marine_animals_network_plot_window.csv")
FRAME_LOG_FILE <- file.path(INPUT_DIR, "marine_animals_network_frame_log.csv")

FRAME_PREFIX <- "marine_animals_network"
GIF_FILE <- file.path(INPUT_DIR, "marine_animals_network_growth.gif")
...
PLOT_TITLE <- "Biodiversity Galiano: Marine Animals"
TITLE_CEX <- 1.60
TITLE_FONT <- 2
SUBTITLE_CEX <- 1
