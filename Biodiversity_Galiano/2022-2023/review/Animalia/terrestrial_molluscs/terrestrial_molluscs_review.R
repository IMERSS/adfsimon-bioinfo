...
baseline <- read.csv("summaries/Galiano_terrestrial_molluscs_review_summary_2023-10-21.csv")
...
iNat.obs.summary <- read.csv("../../../parse_iNat_records/outputs/iNat_obs_terrestrial_molluscs.csv")
...
write.csv(review.summary, "outputs/Galiano_terrestrial_molluscs_review_summary.csv", row.names = FALSE)
