...
baseline <- read.csv("summaries/Galiano_freshwater_and_terrestrial_algae_review_summary_reviewed_2023-11-05.csv")
...
iNat.obs.summary <- read.csv("../../../parse_iNat_records/outputs/iNat_obs_freshwater_and_terrestrial_algae.csv")
...
write.csv(review.summary, "outputs/Galiano_freshwater_and_terrestrial_algae_review_summary.csv", row.names = FALSE)
