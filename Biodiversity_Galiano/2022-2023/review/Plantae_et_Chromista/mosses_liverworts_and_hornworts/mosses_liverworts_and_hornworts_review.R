...
baseline <- read.csv("summaries/Galiano_mosses_liverworts_and_hornworts_review_summary_2023-10-21.csv")
...
iNat.obs.summary <- read.csv("../../../parse_iNat_records/outputs/iNat_obs_mosses_liverworts_and_hornworts.csv")
...
unmatched.iNat.obs.summary$Stats.Code <- 'BRY'
...
write.csv(review.summary, "outputs/Galiano_mosses_liverworts_and_hornworts_review_summary.csv", row.names = FALSE)
