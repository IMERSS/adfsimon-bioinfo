...
# File paths
baseline_path <- "summaries/Terrestrial_mammals_review_summary_reviewed_2026-04-05.csv"
inat_path <- "../../../parse_records/outputs/iNat_obs_terrestrial_mammals.csv"
review_notes_path <- "outputs/Terrestrial_mammals_review_summary_review_notes.csv"
taxon_rule_log_path <- "outputs/Terrestrial_mammals_taxon_rule_log.csv"
change_log_path <- "outputs/Terrestrial_mammals_exclusion_change_log.csv"
harvested_rules_path <- "outputs/Terrestrial_mammals_manual_rules_harvested_this_cycle.csv"
output_path <- "outputs/Terrestrial_mammals_review_summary.csv"
...
unmatched.iNat.obs.summary$Stats.Code <- "MAM"
