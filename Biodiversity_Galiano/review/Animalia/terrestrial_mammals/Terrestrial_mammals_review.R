...
baseline <- read.csv("summaries/Terrestrial_mammals_review_summary_2023-10-17.csv")
...
iNat.obs.summary <- read.csv("../../../parse_iNat_records/outputs/iNat_obs_terrestrial_mammals.csv")
...
write.csv(review.summary, "outputs/Terrestrial_mammal_review_summary.csv", row.names = FALSE)