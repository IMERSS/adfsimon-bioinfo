...
# File paths
baseline_path <- "summaries/Galiano_herptiles_summary_2026-04-05.csv"
inat_path <- "../../../parse_records/outputs/iNat_obs_herptiles.csv"
review_notes_path <- "outputs/Galiano_herptiles_review_notes.csv"
taxon_rule_log_path <- "outputs/Galiano_herptiles_taxon_rule_log.csv"
change_log_path <- "outputs/Galiano_herptiles_exclusion_change_log.csv"
harvested_rules_path <- "outputs/Galiano_herptiles_manual_rules_harvested_this_cycle.csv"
output_path <- "outputs/Galiano_herptiles_review_summary.csv"
...
unmatched.iNat.obs.summary$Stats.Code <- "HER"
