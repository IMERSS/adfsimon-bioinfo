...
# File paths
baseline_path <- "summaries/Galiano_terrestrial_arthropods_review_summary_2026-04-05.csv"
inat_path <- "../../../parse_records/outputs/iNat_obs_terrestrial_arthropods.csv"
review_notes_path <- "outputs/Galiano_terrestrial_arthropods_review_notes.csv"
taxon_rule_log_path <- "outputs/Galiano_terrestrial_arthropods_taxon_rule_log.csv"
change_log_path <- "outputs/Galiano_terrestrial_arthropods_exclusion_change_log.csv"
harvested_rules_path <- "outputs/Galiano_terrestrial_arthropods_manual_rules_harvested_this_cycle.csv"
output_path <- "outputs/Galiano_terrestrial_arthropods_review_summary.csv"
...
# Normalize fields (NEW schema only)
...
# Keep earliest observation per taxon
iNat.obs.summary <- iNat.obs.summary %>%
