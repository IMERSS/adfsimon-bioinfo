...
# File paths
baseline_path <- "summaries/Galiano_birds_review_summary_2026-04-05.csv"
inat_path <- "../../../parse_records/outputs/iNat_obs_birds.csv"
review_notes_path <- "outputs/Galiano_birds_review_summary_review_notes.csv"
taxon_rule_log_path <- "outputs/Galiano_birds_taxon_rule_log.csv"
change_log_path <- "outputs/Galiano_birds_exclusion_change_log.csv"
harvested_rules_path <- "outputs/Galiano_birds_manual_rules_harvested_this_cycle.csv"
output_path <- "outputs/Galiano_birds_review_summary.csv"
...
unmatched.iNat.obs.summary$Stats.Code <- "BIR"
