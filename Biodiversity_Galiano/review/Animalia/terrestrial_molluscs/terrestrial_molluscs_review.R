...
# File paths
baseline_path <- "summaries/Galiano_terrestrial_molluscs_review_summary_2023-10-21.csv"
inat_path <- "../../../parse_records/outputs/iNat_obs_terrestrial_molluscs.csv"
review_notes_path <- "outputs/Galiano_terrestrial_molluscs_review_summary_review_notes.csv"
taxon_rule_log_path <- "outputs/Galiano_terrestrial_molluscs_taxon_rule_log.csv"
change_log_path <- "outputs/Galiano_terrestrial_molluscs_exclusion_change_log.csv"
harvested_rules_path <- "outputs/Galiano_terrestrial_molluscs_manual_rules_harvested_this_cycle.csv"
output_path <- "outputs/Galiano_terrestrial_molluscs_review_summary.csv"
...
unmatched.iNat.obs.summary$Stats.Code <- "MOL"
