...
baseline <- read.csv("summaries/Context_model_herptiles_review_summary_2023-12-25.csv")
...
all.records <- read.csv("../../../parse_records/outputs/records_herptiles.csv")
...
write.csv(reconstituted, "outputs/herptiles_review_summary.csv", row.names = FALSE, na="")